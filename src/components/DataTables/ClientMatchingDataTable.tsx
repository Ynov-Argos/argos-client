  ...
  return (
    <section className="data-table-common rounded-sm border border-stroke bg-white py-4 shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex justify-between  px-8 pb-4">
        <div className="w-100">
          <h1 className="text-2xl font-medium">Matching</h1>
          <h2 className="text-lg font-medium">Statut: {matchingInfo?.status} - Total: {matchingInfo?.total}</h2>
        </div>
...
export default ClientMatchingDataTable;
