...
const MultiSelectGroupDropdown: React.FC<DropdownProps> = ({ id, selectOptions, title }) => {
          ...
          <div className="relative z-20 inline-block w-full">
            <div className="relative flex flex-col items-center">
              ...
              <div className="w-full px-4">
                <div
                  className={`absolute top-full left-0 z-40 w-full rounded bg-white shadow dark:bg-form-input ${
                    isOpen() ? '' : 'hidden'
                  }`}
                  ref={dropdownRef}
                >
                  <div className="flex w-full flex-col max-h-60 overflow-y-auto">
...
export default MultiSelectGroupDropdown;
