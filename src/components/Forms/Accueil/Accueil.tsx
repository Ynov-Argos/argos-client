...
<div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5">
      ...
      Depuis 2018 les TPE & PME sont assujetties aux réglementations LAB-FT concernant la lutte contre le blanchiment d’argent et le financement du terrorisme. 
Ces régulation visent à protéger l’intégrité du système financier mais également à renforcer la confiance qu’accordent les client ainsi que les partenaires commerciaux de ces entités.
Pour aligner leurs pratiques avec ces exigences légales et éviter des sanctions sévères, il leur est impératif de se doter d’un outil dédié à la conformité LAB-FT. 

Pour cela ARGOS est le produit qu'il vous faut avec ses différents tarifs pour vos différents besoins.
      </div>
      <div className="relative rounded-sm border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark md:p-9 xl:p-11.5">
